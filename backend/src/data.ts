...
export const requirementsList: IRequirement[] = [
  { id: "REQ-01", category: "PO", question: "A organização possui processos definidos para documentar e atualizar os requisitos internos de segurança da infraestrutura e do código?", expectedEvidence: "Existência de documentação centralizada (como uma Wiki corporativa) detalhando configurações de segurança obrigatórias (ex: portas de rede fechadas, uso de criptografia), evitando que a infraestrutura seja criada sem um padrão definido." },
  { id: "REQ-02", category: "PO", question: "A plataforma entregue ao cliente permite que o administrador defina e trave regras globais de configuração segura (baselines) para o espaço dele?", expectedEvidence: "Disponibilização de um painel ou interface onde o administrador do cliente final possa aplicar regras globais de segurança para o seu próprio ambiente (ex: forçar a complexidade de senhas ou aplicar restrições de IP)." },
  { id: "REQ-03", category: "PO", question: "Exigência formal de garantias de segurança antes da integração de ferramentas externas (como APIs, plugins ou bibliotecas pagas), seja por meio de cláusulas contratuais ou análises prévias de risco do fornecedor.", expectedEvidence: "Cláusulas de segurança em contratos de fornecedores ou uso de ferramentas de análise de risco de terceiros (SCA)." },
  ...
  { id: "REQ-05", category: "PO", question: "A empresa possui controles estabelecidos e padronizados para garantir a segurança das ferramentas de CI/CD contra comprometimentos?", expectedEvidence: "Configurações de segurança ativas na plataforma de CI/CD (ex: restrição de plugins, runners isolados, segurança de container, testes em servidores isolados, etc.)." },
  { id: "REQ-06", category: "PO", question: "As ferramentas de desenvolvimento geram logs imutáveis e automatizam a checagem de critérios de segurança (ex: Quality Gates) antes de cada release?", expectedEvidence: "Regras de bloqueio de avanço configuradas em pipelines (ex: SonarQube bloqueando builds) e logs de auditoria do pipeline." },
