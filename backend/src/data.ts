...
export const requirementsList: IRequirement[] = [
  { id: "REQ-01", category: "PO", question: "Como a empresa documenta e atualiza os requisitos internos de segurança que a infraestrutura de desenvolvimento e o código devem seguir?", expectedEvidence: "Políticas de segurança documentadas e atualizadas, ou matriz de requisitos de segurança (ex: no Confluence/Wiki interno)." },
  { id: "REQ-02", category: "PO", question: "O produto SaaS entregue ao cliente permite que o administrador defina e trave regras globais de configuração segura (baselines) para o espaço dele?", expectedEvidence: "Demonstração no painel do SaaS de políticas globais configuráveis pelo administrador do tenant." },
  { id: "REQ-03", category: "PO", question: "Qual é o processo para exigir e verificar que os fornecedores de bibliotecas ou ferramentas de terceiros cumprem os requisitos de segurança da empresa?", expectedEvidence: "Cláusulas de segurança em contratos de fornecedores ou uso de ferramentas de análise de risco de terceiros (SCA)." },
  { id: "REQ-04", category: "PO", question: "Existem papéis de segurança definidos no time (ex: Security Champions), e os desenvolvedores recebem treinamento formal focado em código seguro?", expectedEvidence: "Matriz RACI do time de desenvolvimento e registros de conclusão de treinamentos de segurança (AppSec)." },
  { id: "REQ-05", category: "PO", question: "Como vocês garantem a segurança e a padronização das ferramentas de CI/CD usadas no pipeline (ex: GitHub Actions, Jenkins) contra comprometimentos?", expectedEvidence: "Configurações de segurança ativas na plataforma de CI/CD (ex: restrição de plugins, runners isolados)." },
  ...
  { id: "REQ-07", category: "PO", question: "A plataforma SaaS exporta logs de auditoria detalhados e imutáveis sobre as atividades dos usuários diretamente para as ferramentas de monitoramento (SIEM) do cliente?", expectedEvidence: "Tela do SaaS ou documentação técnica de API/Webhook mostrando a exportação de logs de auditoria do cliente." },
  { id: "REQ-08", category: "PO", question: "Como os ambientes de desenvolvimento e produção são isolados entre si, e como vocês garantem que os acessos internos (dos engenheiros) exijam MFA e sigam o Zero Trust?", expectedEvidence: "Configurações de rede (VPCs, Security Groups) e painel de IAM interno (ex: AWS IAM) mostrando MFA obrigatório para engenheiros." },
  ...
  { id: "REQ-10", category: "PO", question: "Como a empresa integra lições aprendidas e avalia novas ferramentas ou linguagens para melhorar o processo após identificar uma nova ameaça ou incidente?", expectedEvidence: "Documentação de análises post-mortem ou roadmaps de segurança comprovando a adoção de novas práticas/ferramentas." },
  { id: "REQ-11", category: "PS", question: "Como vocês protegem o repositório de código contra adulterações internas e externas? Existe exigência de assinatura de commits e controle de acesso rigoroso?", expectedEvidence: "Configurações do repositório (ex: GitHub/GitLab) mostrando regras de proteção de branch, RBAC e exigência de commit signing." },
  ...
  { id: "REQ-19", category: "PW", question: "Como vocês monitoram continuamente as bibliotecas de terceiros (open-source) em busca de vulnerabilidades (CVEs), abandono de projeto ou mudanças suspeitas de donos?", expectedEvidence: "Demonstração de uma ferramenta de Análise de Composição de Software (SCA) (ex: Snyk, Dependabot) rodando no pipeline e gerando alertas de dependência." },
  { id: "REQ-20", category: "PW", question: "Quais são as práticas de codificação segura (Secure Coding) implementadas no dia a dia? Vocês utilizam 'linters' de segurança ou validações obrigatórias de input nas IDEs?", expectedEvidence: "Documento de diretrizes de desenvolvimento seguro interno E tela de configuração do repositório/pipeline com linters de segurança ativos (SAST leve)." },
  { id: "REQ-21", category: "PW", question: "Como vocês configuram os compiladores e ferramentas de build para evitar vulnerabilidades? Existe a política de 'clean build' onde avisos de segurança bloqueiam a compilação?", expectedEvidence: "Configurações de compilador/pipeline mostrando flags de segurança ativas (ex: ASLR, DEP) e bloqueio por warnings." },
  ...
  { id: "REQ-28", category: "RV", question: "Se o tenant de um cliente for afetado por um vazamento, como e em quanto tempo a plataforma o notifica oficialmente?", expectedEvidence: "SLAs de notificação em contrato (ex: notificação em até 24h) e interface de configuração de contatos de emergência no SaaS." },
